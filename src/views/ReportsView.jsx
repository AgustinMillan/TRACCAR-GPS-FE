...
function ReportsView() {
  ...
  return (
    <div className="reports-view">
      ...
      {loading ? (
        ...
        <div className="reports-content">
          <div className="summary-cards">
            ...
            <div
              className={`summary-card balance-card ${netBalance >= 0 ? "positive" : "negative"}`}
            >
              <div className="card-icon">💰</div>
              <div className="card-details">
                <h3>Balance Neto</h3>
          ...
          <div className="chart-section">
            ...
            {chartData.length > 0 ? (
              ...
              <div className="empty-chart">
                <p>
                  No se registraron gastos (egresos) en este mes para generar el
                  gráfico.
                </p>
              </div>
            )}
      ...
      {/* BOTONCATEGORIAS */}
      <button className="btn-add" onClick={() => navigate("/categories")}>
